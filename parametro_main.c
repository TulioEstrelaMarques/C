...
main(int argc, char *argv[]){
    ...
    if(argc == 4){ /* Testa se o numero de parametros fornecidos esta' correto o primeiro parametro é o nome do programa, o segundo o dia o terceiro o mes e o quarto os dois ultimos algarismos do ano */
